...
export default defineConfig({
  ...
  webServer: {
    ...
    env: {
      ...
      'Runbooks__SemanticRetrieval__SourceRegistryPath': '.tmp/e2e-data/runbook-sources.json',
      'Monitoring__Enabled': 'true',
      'Monitoring__StartupDelaySeconds': '300',
      'Monitoring__StatePath': '.tmp/e2e-data/monitoring-state.json',

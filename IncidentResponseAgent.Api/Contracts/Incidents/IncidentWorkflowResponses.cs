...
public sealed record ProviderTransparencyResponse(string ModelProvider, string? Model, string EmbeddingProvider, string VectorStore, string RagStatus, bool UsedModelFallback, string? FallbackReason, bool IsDegraded, string? DegradedReason, bool UsedStructuredOutputRetry = false, string? StructuredOutputRetryReason = null, string? AttemptedModelProvider = null, string? AttemptedModel = null, long EvidenceGatheringDurationMilliseconds = 0, long RagDurationMilliseconds = 0, long ModelDurationMilliseconds = 0, string? FallbackStage = null, string? TimeoutSource = null, string? ModelResponseWarning = null);
